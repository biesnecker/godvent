...
func GetSolutions() map[string]types.Solution {
	return map[string]types.Solution{
		...
		"year_2021_day_eleven_a":    {Input: "input/2021/day_eleven.txt", Solution: DayElevenA},
		"year_2021_day_eleven_b":    {Input: "input/2021/day_eleven.txt", Solution: DayElevenB},
		"year_2021_day_twelve_a":    {Input: "input/2021/day_twelve.txt", Solution: DayTwelveA},
		"year_2021_day_twelve_b":    {Input: "input/2021/day_twelve.txt", Solution: DayTwelveB},
		"year_2021_day_thirteen_a":  {Input: "input/2021/day_thirteen.txt", Solution: DayThirteenA},
		"year_2021_day_thirteen_b":  {Input: "input/2021/day_thirteen.txt", Solution: DayThirteenB},
		"year_2021_day_fourteen_a":  {Input: "input/2021/day_fourteen.txt", Solution: DayFourteenA},
		"year_2021_day_fourteen_b":  {Input: "input/2021/day_fourteen.txt", Solution: DayFourteenB},
		"year_2021_day_fifteen_a":   {Input: "input/2021/day_fifteen.txt", Solution: DayFifteenA},
		"year_2021_day_fifteen_b":   {Input: "input/2021/day_fifteen.txt", Solution: DayFifteenB},
		"year_2021_day_sixteen_a":   {Input: "input/2021/day_sixteen.txt", Solution: DaySixteenA},
		"year_2021_day_sixteen_b":   {Input: "input/2021/day_sixteen.txt", Solution: DaySixteenB},
		"year_2021_day_seventeen_a": {Input: "input/2021/day_seventeen.txt", Solution: DaySeventeenA},
		"year_2021_day_seventeen_b": {Input: "input/2021/day_seventeen.txt", Solution: DaySeventeenB},
	}
}
