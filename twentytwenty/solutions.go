...
func GetSolutions() map[string]types.Solution {
	return map[string]types.Solution{
		...
		"year_2020_day_thirteen_a": {Input: "input/2020/day_thirteen.txt", Solution: DayThirteenA},
		"year_2020_day_thirteen_b": {Input: "input/2020/day_thirteen.txt", Solution: DayThirteenB},
	}
}
